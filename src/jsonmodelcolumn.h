...
public:
   JsonModelColumn();
    JsonModelColumn(const QString &key, const QString &displayName,const QString &parentKey=QString(),const QString &type=QStringLiteral("text"),const QVariantMap &metadata=QVariantMap()):
